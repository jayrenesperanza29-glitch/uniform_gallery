...
export default function Topbar() {
  ...
  return (
    <nav className="topbar">
      <Link to="/dashboard" className="topbar-brand" onClick={() => setMenuOpen(false)}>
      ...
      {menuOpen && (
        <div className="mobile-menu">
          ...
          {user?.is_admin && <NavLink to="/admin" onClick={() => setMenuOpen(false)}>Manage</NavLink>}
          <button className="nav-logout mobile-logout" onClick={handleLogout}>Sign Out</button>
        </div>
      )}
    </nav>
  )
